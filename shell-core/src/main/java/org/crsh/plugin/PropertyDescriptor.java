...
public abstract class PropertyDescriptor<T> {
  ...
  public static PropertyDescriptor<String> create(
      String name, String defaultValue, String description, boolean secret) {
  ...
  public static PropertyDescriptor<Integer> create(
      String name, Integer defaultValue, String description, boolean secret) {
  ...
  public static PropertyDescriptor<Integer> create(
      String name, Integer defaultValue, String description) {
    return create(name, defaultValue, description, false);
  }

  public static PropertyDescriptor<List> create(
      String name, List defaultValue, String description, boolean secret) {
  ...
  public static PropertyDescriptor<List> create(
      String name, List defaultValue, String description) {
    return create(name, defaultValue, description, false);
  }
  ...
  public static final Map<String, PropertyDescriptor<?>> ALL =
      Collections.unmodifiableMap(INTERNAL_ALL);

  public static final PropertyDescriptor<TimeUnit> VFS_REFRESH_UNIT =
      new PropertyDescriptor<TimeUnit>(
          TimeUnit.class, "vfs.refresh_unit", TimeUnit.SECONDS, "The refresh time unit") {
        @Override
  ...
  public static final PropertyDescriptor<Integer> VFS_REFRESH_PERIOD =
      PropertyDescriptor.create("vfs.refresh_period", (Integer) null, "The refresh rate period");
  ...
  protected PropertyDescriptor(
      Class<T> type, String name, T defaultValue, String description, boolean secret)
      throws NullPointerException {
    if (type == null) {
  ...
  /**
   * Implements the real parsing, the string argument must nto be null. The returned value must not
   * be null instead an exception must be thrown.
   *
   * @param s the string to parse
