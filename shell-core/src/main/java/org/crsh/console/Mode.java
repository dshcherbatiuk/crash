 ...
 * the current status and its possible state and provide an editor action that will modify the state
 * of the editor.
 *
 * @author Julien Viet
 */
public abstract class Mode extends EditorAction {
  ...
  /**
   * Transform a key stroke into a editor action. If no action must be taken, null should be
   * returned.
   *
